...
namespace App.Application.Features.WritingBooks.CacheKeys;

/// <summary>
/// CACHE KEY DEFINITIONS FOR WRITING BOOK ENTITY.
/// </summary>
public static class WritingBookCacheKeys
{
    public static string Prefix => "writingBook";
